...
#set_property PACKAGE_PIN P3 [get_ports {direction_x[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {direction_x[0]}]
#set_property PACKAGE_PIN N3 [get_ports {direction_x[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {direction_x[1]}]
#set_property PACKAGE_PIN P1 [get_ports {direction_y[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {direction_y[0]}]
#set_property PACKAGE_PIN L1 [get_ports {direction_y[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {direction_y[1]}]
