...
#set_property PACKAGE_PIN T1 [get_ports {INT}]					
...
#set_property PACKAGE_PIN V13 [get_ports {PORT_ID[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[0]}]
#set_property PACKAGE_PIN V3 [get_ports {PORT_ID[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[1]}]
#set_property PACKAGE_PIN W3 [get_ports {PORT_ID[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[2]}]
#set_property PACKAGE_PIN U3 [get_ports {PORT_ID[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[3]}]
#set_property PACKAGE_PIN P3 [get_ports {PORT_ID[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[4]}]
#set_property PACKAGE_PIN N3 [get_ports {PORT_ID[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[5]}]
#set_property PACKAGE_PIN P1 [get_ports {PORT_ID[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[6]}]
#set_property PACKAGE_PIN L1 [get_ports {PORT_ID[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PORT_ID[7]}]
...
##VGA Connector
#set_property PACKAGE_PIN G19 [get_ports {IO_STRB}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {IO_STRB}]
